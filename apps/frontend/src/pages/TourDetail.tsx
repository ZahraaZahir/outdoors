...
export default function TourDetail() {
  ...
  if (error || !tour)
    return (
      <div className="pt-24 pb-20 text-center text-muted">Tour not found.</div>
    );
      ...
      <section className="relative h-56 overflow-hidden bg-gradient-to-br from-primary-900 via-primary-800 to-primary-950 sm:h-72">
        ...
        <div className="relative flex h-full items-end">
          <div className="mx-auto w-full max-w-6xl px-4 pb-8 lg:px-6">
            ...
            <h1 className="mt-3 font-heading text-2xl font-bold text-white sm:text-3xl lg:text-4xl">
              {tour.title}
            </h1>
          ...
          <div className="lg:col-span-3">
            {tour.imageUrl ? (
              ...
              <div className="aspect-[16/9] overflow-hidden rounded-2xl bg-gradient-to-br from-primary-100 to-primary-200/60">
                <div className="flex h-full items-center justify-center">
                  <svg
                    className="h-24 w-24 text-primary-400/40"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth={1}
            ...
            <div className="mt-8">
              ...
              <p className="mt-3 leading-relaxed text-muted">
                {tour.description ||
                  `Join us for an unforgettable adventure to ${tour.destination}. This tour offers breathtaking views, authentic experiences, and lasting memories. Limited seats available — book now to secure your spot.`}
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4">
              <div className="rounded-xl border border-primary-100 p-4 text-center">
                <svg
                  className="mx-auto h-6 w-6 text-primary-500"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  strokeWidth={1.5}
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-24 rounded-2xl border border-primary-100 bg-white p-6 shadow-sm">
              ...
              <p className="mt-1 text-sm text-muted">
                {tour.availableSeats} of {tour.maxSeats} seats available
              </p>
              ...
              {user ? (
                <form onSubmit={handleSubmit} className="mt-6">
                  ...
                  {success && (
                    <div className="mb-4 rounded-xl bg-primary-50 px-4 py-3 text-sm text-primary-700">
                      {success}
                    </div>
                  )}
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={(e) =>
                          setForm((p) => ({
                            ...p,
                            seatsBooked: Number(e.target.value),
                          }))
                        }
                        className="w-full rounded-xl border border-gray-200 px-4 py-2.5 text-sm transition-colors focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500/20"
                      >
